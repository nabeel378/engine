    ...
    <nav className="sticky top-0 left-0 right-0 z-50 bg-slate-50">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 hidden md:flex items-center gap-0 bg-secondary rounded-full px-1 py-1">
          <button className="px-4 py-1.5 rounded-full text-sm font-medium text-foreground bg-background transition-colors">
            Home
          </button>
        ...
        <Button className="bg-primary hover:bg-primary text-primary-foreground rounded-md px-5 py-2 h-auto text-sm font-medium relative group overflow-hidden inline-flex items-center justify-center">
